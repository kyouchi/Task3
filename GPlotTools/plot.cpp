...
bool plot::printCommandFile()
{
   ...
   //範囲指定
   auto itr = std::min_element(x.begin(), x.end());
   auto x_min_index = std::distance(x.begin(), itr);
   itr = std::max_element(x.begin(), x.end());
   auto x_max_index = std::distance(x.begin(), itr);
   itr = std::min_element(y.begin(), y.end());
   auto y_min_index = std::distance(y.begin(), itr);
   itr = std::max_element(y.begin(), y.end());
   auto y_max_index = std::distance(y.begin(), itr);
